...
const STAGES = [600, 500, 1400, 2000, 1200];
...
type Row = { primary: string; secondary?: string; mono?: boolean };

export default function ThinkingState({
  activeLabel = "Thinking",
  doneLabel = "Thought",
  rows = [
    { primary: "Reading agent context" },
    { primary: "Choosing tools" },
    { primary: "Drafting a reply" },
  ],
  onSettled,
}: {
  activeLabel?: string;
  ...
  const visible =
    stage < 2 ? 0 : stage === 2 ? Math.min(2, rows.length) : rows.length;
