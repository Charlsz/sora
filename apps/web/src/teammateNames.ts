...
/** Soft role suggestions for first-teammate onboarding (Rakazo-style). */
export const ROLE_SUGGESTIONS = [
  { title: "Inbox", description: "Keeps mail and messages moving" },
  { title: "Research", description: "Finds and summarizes sources" },
  { title: "Ops", description: "Runs checklists and follow-ups" },
  { title: "Writing", description: "Drafts and edits in your voice" },
] as const;
